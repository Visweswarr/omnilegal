...
_SOURCE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "hudoc": {
        ...
        "v2_jurisdiction": "EU",
        "default_doc_type": "case_law",
        "collection": "CASE_LAW_EU",
        "url": "https://hudoc.echr.coe.int",
        "license_note": "Open access (ECHR)",
        "source_type": "official",
        "coverage": "All ECtHR judgments and decisions",
    ...
    "un_treaties": {
        ...
        "v2_jurisdiction": "INTL",
        "default_doc_type": "treaty",
        "collection": "INTL_TREATIES",
        "url": "https://treaties.un.org",
        "license_note": "UN public domain",
        "source_type": "official",
        "coverage": "Multilateral treaties deposited with the UN Secretary-General",
        "access": "OAI-PMH / seed list",
        "source_format": "XML, text",
        "catalog_file": "international.json",
    },
    "pile_of_law": {
        "name": "Pile of Law (HuggingFace)",
        "adapter": "pile_of_law_hf",
        "jurisdiction": "United States",
        "v2_jurisdiction": "US",
        "default_doc_type": "case_law",
        "collection": "CASE_LAW_US",
        ...
        "source_type": "aggregator (HuggingFace dataset)",
        "coverage": "BVA opinions, SCOTUS filings, Federal Register, CFR, state codes",
        "access": "HuggingFace datasets (streaming)",
        "source_format": "text (streaming)",
        "catalog_file": "hf_datasets.json",
    },
    "multi_legal_pile": {
        "name": "MultiLegalPile (HuggingFace)",
        "adapter": "multi_legal_pile_hf",
        "jurisdiction": "European Union",
        "v2_jurisdiction": "EU",
        "default_doc_type": "case_law",
        "collection": "CASE_LAW_EU",
        ...
        "source_type": "aggregator (HuggingFace dataset)",
        "coverage": "EN/EU caselaw and legislation from multiple jurisdictions",
        "access": "HuggingFace datasets (streaming)",
        "source_format": "text (streaming)",
        "catalog_file": "hf_datasets.json",
    },
    "openalex": {
        "name": "OpenAlex (Legal Scholarly Works)",
        "adapter": "openalex_api",
        "jurisdiction": "International",
        "v2_jurisdiction": "INTL",
        "default_doc_type": "commentary",
        "collection": "SCHOLARLY_WORKS",
        "url": "https://api.openalex.org",
        "license_note": "CC0 (OpenAlex metadata)",
        "source_type": "aggregator (scholarly)",
        "coverage": "250M+ scholarly works filtered for Law concept",
        "access": "REST API (no auth, polite pool)",
        "source_format": "JSON",
        "catalog_file": "scholarly.json",
    },
    "core_api": {
        "name": "CORE (Open Access Research)",
        "adapter": "core_api",
        "jurisdiction": "International",
        "v2_jurisdiction": "INTL",
        "default_doc_type": "commentary",
        ...
        "license_note": "Open Access (CORE aggregator)",
        "source_type": "aggregator (scholarly)",
        "coverage": "300M+ open-access research outputs",
        "access": "REST API v3 (free key optional)",
        "source_format": "JSON",
        "catalog_file": "scholarly.json",
    },
    "semantic_scholar": {
        "name": "Semantic Scholar (Legal NLP Papers)",
        "adapter": "semantic_scholar_api",
        "jurisdiction": "International",
        "v2_jurisdiction": "INTL",
        "default_doc_type": "commentary",
        "collection": "LEGAL_NLP_PAPERS",
        "url": "https://api.semanticscholar.org",
        "license_note": "Semantic Scholar API (free academic use)",
        "source_type": "aggregator (scholarly)",
        "coverage": "Legal NLP, judgment prediction, document summarization",
        "access": "REST API (no auth for basic access)",
        "source_format": "JSON",
        "catalog_file": "scholarly.json",
    },
    "doaj": {
        "name": "DOAJ (Open Access Legal Journals)",
        "adapter": "doaj_api",
        "jurisdiction": "International",
        "v2_jurisdiction": "INTL",
        "default_doc_type": "commentary",
        "collection": "SCHOLARLY_WORKS",
        "url": "https://doaj.org",
        "license_note": "Open Access (DOAJ)",
        "source_type": "aggregator (open access journals)",
        "coverage": "Open-access legal journal articles",
        "access": "REST API (no auth)",
        "source_format": "JSON",
        "catalog_file": "scholarly.json",
    },
    "arxiv_legal": {
        "name": "arXiv (Legal NLP Papers)",
        "adapter": "arxiv_legal_api",
        "jurisdiction": "International",
        "v2_jurisdiction": "INTL",
        "default_doc_type": "commentary",
        "collection": "LEGAL_NLP_PAPERS",
        "url": "https://arxiv.org",
        "license_note": "arXiv (CC-BY / open access)",
        "source_type": "preprint repository",
        "coverage": "cs.CL and cs.AI papers on legal NLP topics",
        "access": "Atom API (no auth)",
        "source_format": "XML (Atom)",
        "catalog_file": "scholarly.json",
    },
    "tn_ogd": {
        "name": "Tamil Nadu Open Government Data",
        "adapter": "tn_ogd_ckan",
        "jurisdiction": "India",
        "v2_jurisdiction": "IN",
        "default_doc_type": "statute",
        "collection": "STATUTES_IN",
        "url": "https://tn.data.gov.in",
        "license_note": "Government Open Data License - India",
        "source_type": "official (state government)",
        "coverage": "Judiciary, legal aid, court datasets (metadata only)",
        "access": "CKAN API (no auth)",
        "source_format": "JSON (metadata), CSV/XLS (raw data — not ingested)",
        "catalog_file": "national_in.json",
    },
    "caselaw_access_project": {
        "name": "Caselaw Access Project (via CourtListener)",
        "adapter": "courtlistener_api",
        "jurisdiction": "United States",
        "v2_jurisdiction": "US",
        "default_doc_type": "case_law",
        "collection": "CASE_LAW_US",
        "url": "https://www.courtlistener.com",
        "license_note": "Public domain (subsumed by CourtListener post-2024)",
        "source_type": "aggregator (redirect)",
        "coverage": "Harvard CAP corpus now available through CourtListener",
        "access": "REST API v4 (via CourtListener)",
        "source_format": "JSON, plain text",
        "catalog_file": "national_us.json",
    },
}
